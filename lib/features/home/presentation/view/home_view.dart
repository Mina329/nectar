...
class _HomeViewState extends State<HomeView> {
  late Map<Type, Widget> _stateBodyMap;
  ...
  void initState() {
    ...
    BlocProvider.of<NavigationBarCubit>(context).savedPageController =
        pageController;
    scrollController = ScrollController();
    buildPagesStates();
  }

  void buildPagesStates() {
    _stateBodyMap = {
        ...
        providers: [
          ...
          BlocProvider(
            create: (context) => CityCountryCubit(
              getIt.get<ShopRepo>(),
            )..getCityCountry(CacheData.getData(key: CacheKeys.kLANGUAGE) ==
                    CacheValues.ARABIC
                ? "ar"
                : "en"),
          ),
